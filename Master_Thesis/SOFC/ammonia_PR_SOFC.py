...
def get_rxn(property_package, reactions=None, scaled=False):
    rxns = {
        ...
        #         "equilibrium_form": log_power_law_equil, # power_law_equil  Use correct equilibrium form
        #         "concentration_form": ConcentrationForm.moleFraction,
        #         "parameter_data": {
        #             "dh_rxn_ref": (45898, pyunits.J / pyunits.mol), #from excel emanuele at 298.15K Negative is the formation, positive the decomposition
        #             "k_eq_ref": (0.00133, pyunits.dimensionless),    #calculated at 298.15K
        #             "T_eq_ref": (298.15, pyunits.K), #25 C
        #             "energy_activation": (1200000, pyunits.J / pyunits.mol), #https://www.jstage.jst.go.jp/article/jcej/49/1/49_14we431/_pdf/-char/en Non credo venga usata, messa a zero il risultato non cambia
        #             # "reaction_order": {
        #             #     ("Vap", "NH3"): -1,
        #             #     ("Vap", "N2"): 0.5,
        #             #     ("Vap", "H2"): 1.5,
