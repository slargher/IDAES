...
class SofcDesignData(UnitModelBlockData):
    ...
    def _add_arcs(self):
        ...
        self.heat_n2_to_mix_out             = Arc(source=self.translator_n2.outlet,
    ...
    def _add_constraints(self):
        ...
        def sofc_energy_balance(b, t):
            return (
                pyo.units.convert(b.heater_air.control_volume.heat[t], to_units=pyo.units.W)
                == - b.sofc_power_dc[t]
                - pyo.units.convert(b.reactor.control_volume.heat_of_reaction[t], to_units=pyo.units.W)
                + pyo.units.convert(b.cracker.control_volume.heat_of_reaction[t], to_units=pyo.units.W)
